...
/**
 * check_elf - This file checks if a file is an ELF file.
 * @e_ident: This is pointer that points to an array containing the ELF magic numbers.
 ...
 * @e_ident: This is the  pointer to an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * @e_type: This is the type of an ELF.
 * @e_ident: This is a pointer to an array containing the ELF class.
 */
...
/**
 * main - This will contain displays the information contained in the ELF header
 *
 * @argc: These are the  number of arguments supplied to the program.
 * @argv: This is an endeletlise array of pointers to the arguments.
 *
 * Return: 0 on success.
 *
